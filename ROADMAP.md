...
- **Any Given Tuesday, next beats.** Quarterbacks alone; turf against grass from the nflverse stadium surfaces; career length from the rosters; the league's IQVIA figures typed in as a second series. Also worth trying: a "who's hurt now" view by position with the depth chart. *(2026-09-22)*
...
- Any Given Tuesday, first draft: player-weeks lost per team per week (Out on the report plus reserve list) 2009 to this week from the nflverse files, team picker with every chart following it, body-part and position shares, the 32-team scatter with rank table, this week's Out list, ten rule-change milestones; refreshes Monday, Thursday and Saturday. *(2026-09-22)*
